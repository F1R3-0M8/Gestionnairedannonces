...
class Category extends \App\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Category' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Category' . "\0" . 'name', '' . "\0" . 'App\\Entity\\Category' . "\0" . 'annonces'];
        }
     ...
     * {@inheritDoc}
     */
    public function addAnnonce(\App\Entity\Annonce $annonce): \App\Entity\Category
    {
     ...
     * {@inheritDoc}
     */
    public function removeAnnonce(\App\Entity\Annonce $annonce): \App\Entity\Category
    {
