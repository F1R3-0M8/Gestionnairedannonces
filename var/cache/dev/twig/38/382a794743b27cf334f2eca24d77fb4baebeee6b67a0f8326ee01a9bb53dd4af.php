...
class __TwigTemplate_417820ed1834196b0b0c807b0aaf6fae858469187b9c9c4866d346aac397218f extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    <h1 style=\"font-family: 'Bebas Neue';  font-size: 66px; color:white; text-shadow: 1px 1px 2px black;\"><center>User<center></h1>
    ...
    <div class=\"btn-group btn-block\" role=\"group\">
        ...
        // line 31
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("admin_user_edit", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 31, $this->source); })()), "id", [], "any", false, false, false, 31)]), "html", null, true);
...
";
    ...
    {
        return array (  136 => 34,  130 => 31,  126 => 30,  117 => 24,  110 => 20,  103 => 16,  96 => 12,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    <h1 style=\"font-family: 'Bebas Neue';  font-size: 66px; color:white; text-shadow: 1px 1px 2px black;\"><center>User<center></h1>
    ...
    <div class=\"btn-group btn-block\" role=\"group\">
        <a class=\"btn btn-dark\"href=\"{{ path('admin_user_index') }}\"><i class=\"fas fa-undo\"></i></a>
        <a class=\"btn btn-warning\" href=\"{{ path('admin_user_edit', {'id': user.id}) }}\"><i class=\"fas fa-pencil-alt\"></i></a>
    </div>
    <br>
    {{ include('admin/user/_delete_form.html.twig') }}
{% endblock %}
", "admin/user/show.html.twig", "C:\\wamp64\\www\\FormationPLM\\SF\\gestannonces\\templates\\admin\\user\\show.html.twig");
    }
}
