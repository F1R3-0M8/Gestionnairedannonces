...
class __TwigTemplate_6fb675976fbe5e530292839dafc851f2d7d8e540640520bf788c471bd5299cdb extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    <h1 style=\"font-family: 'Bebas Neue';  font-size: 66px;\"><center>Edit Category<center></h1>
...
{% block body %}
    <h1 style=\"font-family: 'Bebas Neue';  font-size: 66px;\"><center>Edit Category<center></h1>
    <a class=\"btn btn-dark btn-block\" href=\"{{ path('admin_category_index') }}\"><i class=\"fas fa-undo\"></i></a>
    <br>
    {{ include('admin/category/_form.html.twig', {'button_label': 'Update'}) }}
    
    {{ include('admin/category/_delete_form.html.twig') }}
{% endblock %}
", "admin/category/edit.html.twig", "C:\\wamp64\\www\\FormationPLM\\SF\\gestannonces\\templates\\admin\\category\\edit.html.twig");
    }
}
