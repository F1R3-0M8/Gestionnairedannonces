...
class __TwigTemplate_5ff9b35146418dac226fce5655cfc0e554ba4f84bd87424fc7712d5e28e51763 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    <h1 style=\"font-family: 'Bebas Neue';  font-size: 66px; color:white; text-shadow: 1px 1px 2px black;\"><center>Categories admin<center></h1>
    ...
    <table class=\"table table-striped text-center\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["category"]) {
            ...
            // line 23
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("admin_category_show", ["id" => twig_get_attribute($this->env, $this->source, $context["category"], "id", [], "any", false, false, false, 23)]), "html", null, true);
            echo "\"><i class=\"far fa-eye\"></i></a>
                    <a class=\"btn btn-warning\" href=\"";
            // line 24
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("admin_category_edit", ["id" => twig_get_attribute($this->env, $this->source, $context["category"], "id", [], "any", false, false, false, 24)]), "html", null, true);
...
";
    ...
    {
        return array (  144 => 32,  135 => 28,  126 => 24,  122 => 23,  117 => 21,  113 => 20,  110 => 19,  105 => 18,  91 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    <h1 style=\"font-family: 'Bebas Neue';  font-size: 66px; color:white; text-shadow: 1px 1px 2px black;\"><center>Categories admin<center></h1>
    <a class=\"btn btn-warning btn-block\" href=\"{{ path('admin_category_new') }}\">New</a>
    <br>
    <table class=\"table table-striped text-center\">
        <thead class=\"thead-dark\">
            <tr>
        ...
        {% for category in categories %}
            <tr>
                ...
                <td>{{ category.name }}</td>
                <td>
                    <a class=\"btn btn-primary\" href=\"{{ path('admin_category_show', {'id': category.id}) }}\"><i class=\"far fa-eye\"></i></a>
...
{% endblock %}
", "admin/category/index.html.twig", "C:\\wamp64\\www\\FormationPLM\\SF\\gestannonces\\templates\\admin\\category\\index.html.twig");
    }
}
