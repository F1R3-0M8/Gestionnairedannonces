...
class __TwigTemplate_a6899d1b8b3b317ba0643e73d7f34c675828a62b3a4e9e371b6026eba9e888ef extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("base.html.twig", "admin/user/new.html.twig", 1);
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    <h1 style=\"font-family: 'Bebas Neue';  font-size: 66px;\"><center>Create new User<center></h1>
...
{% block body %}
    <h1 style=\"font-family: 'Bebas Neue';  font-size: 66px;\"><center>Create new User<center></h1>

    {{ include('admin/user/_form.html.twig') }}

    <a class=\"btn btn-dark btn-block\" href=\"{{ path('admin_user_index') }}\"><i class=\"fas fa-undo\"></i></a>
{% endblock %}
", "admin/user/new.html.twig", "C:\\wamp64\\www\\FormationPLM\\SF\\gestannonces\\templates\\admin\\user\\new.html.twig");
    }
}
