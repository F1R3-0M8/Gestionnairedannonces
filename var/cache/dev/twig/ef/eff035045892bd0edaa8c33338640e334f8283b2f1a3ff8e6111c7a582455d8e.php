...
class __TwigTemplate_c579d7499691845b70342d10a7a18694ef855e49e347519dfc360fbbf156f076 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <div class=\"btn btn-dark btn-block\">{{ form_widget(form) }}</div>
    <button class=\"btn btn-success btn-block\">{{ button_label|default('Save') }}</button>
{{ form_end(form) }}
", "admin/category/_form.html.twig", "C:\\wamp64\\www\\FormationPLM\\SF\\gestannonces\\templates\\admin\\category\\_form.html.twig");
    }
}
